...
class RecommendationAgent:
    ...
    SystemMessage(
        content=(
            f"You are an expert insurance recommender. Recommend an insurance plan for the following product: {product}.\n\n"
            "Analyze the user's information and recommend a plan tier (e.g., "
            "Basic/Silver/Gold/Platinum for Travel; "
            "Basic/Enhanced/Premier/Exclusive for Maid; "
            "All Workshop / Authorised Workshop / Third Party Fire & Theft for Car)."  # [prev: no Car examples]
            f"\n\nUser information: {collected_info}\n\n"
            "Return ONLY a JSON object like: {\"plan\": \"<tier>\"}"
        )
    ),
